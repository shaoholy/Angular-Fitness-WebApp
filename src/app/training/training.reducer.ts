...
import { SET_AVAILABLE_TRAININGS, SET_FINISHED_TRAININGS, START_TRAINING, STOP_TRAINING, TrainingAcitons } from './training.actions';
...
export function trainingReducer(state = initialState, action: TrainingAcitons) {
    switch (action.type) {
